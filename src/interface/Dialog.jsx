    ...
    buttons.map(({ type: btnType, label, ...others }, idx) => (
      <TouchableHighlight
        ...
        style={[
          ...
          _type === "android" && idx === buttons.length - 1
            ? styles.dialogFooterOprWithNegativeMarginRight
            : {}
        ]}
    ...
    >
      <Mask style={[styles.dialogWrapper, maskStyle]} onPress={onClose}>
        <View style={[styles.dialog, style]}>
          ...
          <View
            style={[styles.dialogBody, styles[`${type}DialogBody`], bodyStyle]}
          >
            {childrenWithProps}
          </View>
          <View
